    ...
    <div class="col-md-8 col-md-offset-2">
      <div class="text-center">
        <?php if($user->photo == null): ?>
          <a href="#" data-toggle="modal" data-target="#modalPhoto"><img class="img-responvive img-circle center-block" width="300" src="<?php echo base_url("/img/user.png")  ?>" alt="Sua foto" width="300px" id="userImage" class="userImage"></a>-
        <?php else: ?>
          <a href="#" data-toggle="modal" data-target="#modalPhoto"><img class="img-responvive img-circle center-block" width="300" src="<?php echo base_url('/uploads/users/' . $user->email . '/'  .  $user->photo )  ?>" alt="Sua foto" width="300px" id="userImage" class="userImage"></a>
        <?php endif ?>
