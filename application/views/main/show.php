  ...
  <div class="row">
      ...
      <div class="col-md-12">
        <div class="row">
          <?php for ($i=2; $i < 5; $i++):?>
           <div class="col-md-4">
             <?php if(isset($data[$pet->id][$i])): ?>
               <img src="<?php echo base_url('/uploads/pets/' . $pet->id . '/'  .  $data[$pet->id][$i] ) ?>" class="center-block img-responsive img-thumbnail img-deco" width="300px" alt="Imagens do pet">
             <?php endif ?>
          </div>
        <?php endfor ?>
        </div>
